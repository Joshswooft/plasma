...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: GpRZzOw2uZgYN/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox___4YeMk, {
            [sty.freeBox__long___4YeMkNudxv]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          <div
            className={classNames(defaultcss.all, sty.freeBox__aKGgH, {
              [sty.freeBox__long__aKGgHnudxv]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__axVqU)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__fhsuX, {
          [sty.freeBox__long__fhsuXnudxv]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__jjjn, {
            [sty.freeBox__long__jjjnNudxv]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__kweE)}
                role={"img"}
              />
            ),
