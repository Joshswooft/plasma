...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: PNSLarptRoOn5/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__rAkBa)}
              role={"img"}
            />
          ),
