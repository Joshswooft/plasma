...
import BaseCard from "../../BaseCard"; // plasmic-import: vmTqKIv2tV0IdM/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: G9GtO1co1dnnIv/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__rjGeg)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__uhmgl)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__vujbW)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet___7AjjY)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__dTaKd)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__wrNjv)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__twcBz)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
