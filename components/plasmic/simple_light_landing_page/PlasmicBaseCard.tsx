...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: vmTqKIv2tV0IdM/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__d87I4, {
          [sty.freeBox__long__d87I4P30HS]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__eIeS9, {
            [sty.freeBox__long__eIeS9P30HS]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__pGmDb)}
                role={"img"}
              />
            ),
