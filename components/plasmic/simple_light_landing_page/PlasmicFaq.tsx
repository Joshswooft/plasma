...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: IikVbGFPSD_e3X/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__br6Qk)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__fnFab)}>
          <div className={classNames(defaultcss.all, sty.freeBox___9L5G)}>
            {p.renderPlasmicSlot({
