...
import Avatar from "../../Avatar"; // plasmic-import: rg5W3a3g8k45RT/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 4jQh-uanHdOK3g/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: H9EtD-x5Wx6-2o/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__eUaq)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__cBoxX)}
        >
          <div
            className={classNames(
              defaultcss.all,
