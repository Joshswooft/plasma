...
import Avatar from "../../Avatar"; // plasmic-import: Beivagj7o-g0/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: Yj7xu_zidJUc/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: yUWPsfPGF1Tv/icon
  ...
  return (
    ...
    >
      <Avatar
        ...
        pic={
          <img
            ...
            src={"/plasmic/test_project/images/profilepic.png"}
          />
        }
      />
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox___1RqEx)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___6GsC4)}
        >
          <div
            className={classNames(
              defaultcss.all,
