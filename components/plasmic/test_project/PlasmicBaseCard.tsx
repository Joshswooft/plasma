...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: hn95vG55egac/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__dlgvH, {
          [sty.freeBox__long__dlgvHxl67Q]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__p0FSy, {
            [sty.freeBox__long__p0FSyxl67Q]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg___6T2Fo)}
                role={"img"}
              />
            ),
