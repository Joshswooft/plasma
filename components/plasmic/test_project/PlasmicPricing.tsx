...
import Plan from "../../Plan"; // plasmic-import: 4xYecELwkCsL/component
...
import Faq from "../../Faq"; // plasmic-import: A7si4kILL7eN/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: LpXf24m_gFeL/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__xKewz)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__bvmyu)}
              subtitle={
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__eIfHz)}
            >
              <Plan
                className={classNames("__wab_instance", sty.plan__cKQb)}
                price={
                  <div
                    className={classNames(
                      defaultcss.all,
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__ed0VF)}
                description={
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__iT2O6)}
                  >
                    <Bullet
                      className={classNames(
                        "__wab_instance",
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__u8Jcv)}
                name={"Enterprise"}
                price={
                  <div
                    className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section__b6Sv)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__c0I7)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__d6DgG)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__lfvVy)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
