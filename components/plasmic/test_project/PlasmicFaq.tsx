...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: A7si4kILL7eN/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__icEX)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__z02FQ)}>
          <div className={classNames(defaultcss.all, sty.freeBox__hIfMf)}>
            {p.renderPlasmicSlot({
